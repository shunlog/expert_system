#+title: Lab 1: "Expert (hopefully) systems", at FCIM.FIA
#+author: Artiom Balan
#+PROPERTY: header-args:python :exports both :session *python-lab1-FIA-session*
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="https://gongzhitaao.org/orgcss/org.css"/>
#+cite_export: basic numeric noauthor/bare

#+BEGIN_SRC elisp :exports none 
(setq org-babel-python-command "/home/awh/uni/courses/FIA/lab1/expert_system/.venv/bin/python")
#+END_SRC

#+RESULTS:
: /home/awh/uni/courses/FIA/lab1/expert_system/.venv/bin/python
...
You can draw the goal tree DAG using =render_DAG= which uses the [[https://graphviz.org/][graphviz]] library:
...
There arrows are pointing from the parents to the children, which is [[https://en.wikipedia.org/wiki/And%E2%80%93or_tree][the more common notation]].
...
#+RESULTS:
[[file:out/diagram.png]]

* Task 3: Forward chaining
...
In the MIT book on AI [cite:@winston1992AI], the facts in the expert system can only be tree.
...
for the lack of a better term [fn:1].
...
* Task 6: Wrap it up in an interactive system
...
* Task 7: human-readable questions
...
| =it is ...=                        | =is it ...?=                          |
| =it has ...=                       | =does it have ...?=                   |
| =it <verb that ends with "s"> ...= | =does it <verb without the "s"> ...?= |
...
[fn:1] I did spend some time researching and-or trees and expert systems online,
